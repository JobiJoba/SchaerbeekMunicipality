...
public sealed class DocumentRequestCaseAuthorization
{
    ...
    public bool IsReadOnlyDueToLock(OfficerRole role, DocumentRequestCase documentRequestCase, OfficerId currentOfficerId) =>
        role == OfficerRole.PopulationOfficer &&
    ...
    public bool ShouldAutoClaim(DocumentRequestCase documentRequestCase, OfficerId currentOfficerId) =>
        documentRequestCase.LockedByOfficerId is null &&
