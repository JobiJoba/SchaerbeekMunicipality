    ...
    : MunicipalApiClientBase(httpClient, currentOfficer), IChangeOfAddressApi
{
    ...
    public Task<IReadOnlyList<ChangeOfAddressCaseListItem>> ListCasesAsync(
        CancellationToken cancellationToken = default)
    {
        return GetJsonAsync<IReadOnlyList<ChangeOfAddressCaseListItem>>($"{BasePath}/cases", cancellationToken);
    }
    ...
    public Task<OpenChangeOfAddressCaseResponse> OpenCaseAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return PostJsonAsync<OpenChangeOfAddressCaseRequest, OpenChangeOfAddressCaseResponse>(
            $"{BasePath}/cases",
            request,
            cancellationToken);
    }
    ...
    {
        return GetJsonAsync<ChangeOfAddressCaseDetailDto>($"{BasePath}/cases/{id}", cancellationToken);
    }

    public Task<ClaimChangeOfAddressCaseResponse> ClaimCaseAsync(Guid id, CancellationToken cancellationToken = default)
    {
        return PostJsonAsync<ClaimChangeOfAddressCaseResponse>($"{BasePath}/cases/{id}/claim", cancellationToken);
    }

    public Task<ClaimChangeOfAddressCaseResponse?> TryAutoClaimCaseAsync(Guid id,
        CancellationToken cancellationToken = default)
    {
        return PostJsonOptionalAsync<ClaimChangeOfAddressCaseResponse>($"{BasePath}/cases/{id}/auto-claim",
            cancellationToken);
    }
    ...
    public Task<DeclareNewAddressResponse> DeclareNewAddressAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return PostJsonAsync<DeclareNewAddressRequest, DeclareNewAddressResponse>(
    ...
    public Task<UpdateHouseholdForMoveResponse> UpdateHouseholdForMoveAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return PostJsonAsync<UpdateHouseholdForMoveRequest, UpdateHouseholdForMoveResponse>(
    ...
    public Task<UnlinkHouseholdMemberResponse> UnlinkHouseholdMemberAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return DeleteJsonAsync<UnlinkHouseholdMemberResponse>($"{BasePath}/cases/{id}/household/{personId}",
            cancellationToken);
    }
    ...
    public Task<ChangeOfAddressChecklistResponse> GetChecklistAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return GetJsonAsync<ChangeOfAddressChecklistResponse>($"{BasePath}/cases/{id}/checklist", cancellationToken);
    }

    public Task<ConfirmAddressChangeResponse> ConfirmAsync(Guid id, CancellationToken cancellationToken = default)
    {
        return PostJsonAsync<ConfirmAddressChangeResponse>($"{BasePath}/cases/{id}/confirm", cancellationToken);
    }
    ...
    public Task<RejectChangeOfAddressResponse> RejectAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return PostJsonAsync<RejectChangeOfAddressRequest, RejectChangeOfAddressResponse>(
