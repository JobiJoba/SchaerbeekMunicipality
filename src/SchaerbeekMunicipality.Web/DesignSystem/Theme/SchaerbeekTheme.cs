...
public static class SchaerbeekTheme
{
    ...
    private static Typography BuildTypography() => new()
    {
        ...
        H1 = new H1Typography { FontSize = "2rem", FontWeight = "700", LineHeight = "1.5", LetterSpacing = "normal" },
        H2 = new H2Typography { FontSize = "1.5rem", FontWeight = "700", LineHeight = "1.5", LetterSpacing = "normal" },
        H3 = new H3Typography { FontSize = "1.25rem", FontWeight = "700", LineHeight = "1.5", LetterSpacing = "normal" },
        H4 = new H4Typography { FontSize = "1.125rem", FontWeight = "700", LineHeight = "1.5", LetterSpacing = "normal" },
        H5 = new H5Typography { FontSize = "1rem", FontWeight = "700", LineHeight = "1.5", LetterSpacing = "normal" },
        H6 = new H6Typography { FontSize = "0.875rem", FontWeight = "700", LineHeight = "1.5", LetterSpacing = "0.02em" },
